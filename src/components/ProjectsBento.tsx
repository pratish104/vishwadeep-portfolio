...
export function ProjectsBento() {
  ...
  // Card themes matching the 3 reference screenshots
  const getCardStyle = (type: "digipath" | "retail" | "kosh") => {
    if (isDark) {
      if (type === "digipath") {
        return {
          bg: "bg-[#081815]/90 backdrop-blur-xl",
          border: "border-emerald-500/30 hover:border-emerald-400/60",
          shadow: "shadow-2xl shadow-emerald-950/50",
          ...
          cta: "text-emerald-400 hover:text-emerald-300 font-bold",
      ...
      if (type === "retail") {
        return {
          bg: "bg-[#0a1426]/90 backdrop-blur-xl",
          ...
          cta: "text-blue-400 hover:text-blue-300 font-bold",
      ...
      return {
        bg: "bg-[#130d22]/90 backdrop-blur-xl",
        ...
        cta: "text-purple-400 hover:text-purple-300 font-bold",
    ...
    // Light / Anime Pastel Themes
    if (type === "digipath") {
      return {
        bg: isAnime ? "bg-[#eaf8f0]/95 backdrop-blur-xl" : "bg-[#edf8f2]/95 backdrop-blur-xl",
        ...
        body: "text-gray-600",
        pill: "bg-white/90 border-emerald-200/80 text-emerald-800 font-medium",
        cta: "text-emerald-700 hover:text-emerald-800 font-bold",
        boxBg: "bg-white/90 border-emerald-100 shadow-2xs",
    ...
    if (type === "retail") {
      return {
        bg: isAnime ? "bg-[#eef5fe]/95 backdrop-blur-xl" : "bg-[#f1f6ff]/95 backdrop-blur-xl",
        ...
        body: "text-gray-600",
        pill: "bg-white/90 border-blue-200/80 text-blue-800 font-medium",
        cta: "text-blue-700 hover:text-blue-800 font-bold",
        boxBg: "bg-white/90 border-blue-100 shadow-2xs",
        statVal: "text-blue-800 font-bold",
        statLabel: "text-gray-500",
      };
    }
    return {
      bg: isAnime ? "bg-[#f8f2fe]/95 backdrop-blur-xl" : "bg-[#faf4ff]/95 backdrop-blur-xl",
      ...
      body: "text-gray-600",
      pill: "bg-white/90 border-purple-200/80 text-purple-800 font-medium",
      cta: "text-purple-700 hover:text-purple-800 font-bold",
      boxBg: "bg-white/90 border-purple-100 shadow-2xs",
    ...
    <section id="projects" className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-left">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-6">
        <div className="space-y-1">
          <div
            className={`text-xs font-mono-code font-bold uppercase tracking-wider ${
              isDark ? "text-cyan-400" : isAnime ? "text-pink-600" : "text-emerald-600"
            }`}
          >
            // FEATURED PROJECTS
          </div>
          <h2
            className={`text-2xl sm:text-3xl lg:text-4xl font-serif-display tracking-tight ${
              isDark ? "text-white" : "text-gray-900"
            }`}
          >
            Selected Data &amp; AI Systems
          </h2>
          <p className={`text-xs sm:text-sm ${isDark ? "text-zinc-400" : "text-gray-600"}`}>
        ...
        <button
          ...
          className={`self-start sm:self-auto flex items-center gap-1.5 px-4 py-2 rounded-full border text-xs font-mono-code font-semibold transition-all hover:scale-105 ${
            isDark
              ? "bg-[#0b1224] border-white/10 text-white hover:bg-[#111a33] shadow-lg"
              : "bg-white/95 border-gray-300 text-gray-800 hover:bg-gray-50 shadow-sm"
          }`}
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="space-y-3">
            ...
            <div className={`rounded-2xl border p-1.5 mt-2 overflow-hidden ${dStyle.boxBg}`}>
        ...
        >
          <div className="space-y-3">
            ...
            <div className={`rounded-2xl border p-2.5 mt-2 h-36 sm:h-40 flex flex-col justify-between ${rStyle.boxBg}`}>
              <div className="w-full flex items-center justify-between px-1 text-[10px] font-mono-code opacity-70">
                <span>Revenue Trend</span>
                <span className={isDark ? "text-cyan-400 font-bold" : "text-blue-600 font-bold"}>51K+ Records</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 items-center flex-1 py-1">
                ...
                <svg viewBox="0 0 120 55" className="w-full h-full">
                  <path
                    ...
                    strokeLinecap="round"
                  />
                  <rect x="15" y="25" width="8" height="25" rx="2" fill={isDark ? "#38bdf8" : "#93c5fd"} opacity="0.6" />
                  <rect x="35" y="15" width="8" height="35" rx="2" fill={isDark ? "#0284c7" : "#60a5fa"} opacity="0.8" />
                  <rect x="55" y="20" width="8" height="30" rx="2" fill={isDark ? "#38bdf8" : "#93c5fd"} opacity="0.6" />
                  <rect x="75" y="10" width="8" height="40" rx="2" fill={isDark ? "#0284c7" : "#3b82f6"} opacity="0.9" />
                  <rect x="95" y="5" width="8" height="45" rx="2" fill={isDark ? "#38bdf8" : "#2563eb"} />
                </svg>
                ...
                <div className="flex items-center justify-around h-full">
                  ...
                  <div className="relative w-11 h-11 flex items-center justify-center">
                    ...
                    <span className={`absolute text-[8px] font-bold font-mono-code ${isDark ? "text-cyan-400" : "text-blue-700"}`}>
                      52%
                    </span>
                  </div>
        ...
        >
          ...
          <div
            className={`absolute right-4 top-2 text-4xl sm:text-5xl font-bold font-serif-display select-none pointer-events-none opacity-15 ${
          ...
          <div className="space-y-3 relative z-10">
            {/* Badge */}
            <div className="flex items-center justify-between">
              <span className={`px-3 py-1 rounded-full text-[10px] font-mono-code font-bold uppercase tracking-wider ${kStyle.badge}`}>
                NLP / LANGUAGE
              </span>
            </div>
            ...
            <div className={`rounded-2xl border p-2.5 mt-2 h-36 sm:h-40 flex flex-col justify-between space-y-1.5 ${kStyle.boxBg}`}>
              ...
              >
                <span className={`text-[9px] font-mono-code block font-bold ${isDark ? "text-purple-400" : "text-purple-700"}`}>
                  Input (मराठी)
                </span>
              ...
              >
                <span className={`text-[9px] font-mono-code block font-bold ${isDark ? "text-purple-300" : "text-purple-800"}`}>
                  Output (Formal)
                </span>
                <p className="font-sans text-[11px] font-medium leading-snug line-clamp-2">
